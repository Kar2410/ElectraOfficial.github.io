...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
 ...
 /* body {
        ...
        .divider {
            ...
            border: none;
            height: 20px;
            background-image: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' height='100%' width='100%'><defs><pattern id='dotted' width='15' height='20' patternTransform='rotate(0 0 0)' patternUnits='userSpaceOnUse'><circle cx='3' cy='3' r='3' fill='%23F05346'/><circle cx='12' cy='12' r='3' fill='%23F05346'/> </pattern></defs><rect width='100%' height='100%' fill='url(%23dotted)'/></svg>");
        }
...
<div class="jumbotron pt-6 container-fluid">
        ...
        <br>
        <p style="font-size: 1.2rem;margin-left:auto;margin-right: auto; ">Forming a society of its own under each and every department is an age old tradition in NITS. Hence, Electrical Engineering department too, named as ELECTRA SOCIETY which mainly serves as a link between the teachers and the students. It serves
    ...
    <div class="mb-1 ">
        <div class="container-fluid p-0 " style="overflow-x: hidden; font-family: var(--font2); width: 80%; margin: auto; ">
            <ul style="font-size:1rem;margin-left:auto;margin-right: auto; ">
    ...
    <div class="rank " style="margin: 50px; ">OUR SENIOR MEMBERS</div>
    ...
    <div class="rank " style="margin: 90px; ">OUR JUNIOR MEMBERS</div>
